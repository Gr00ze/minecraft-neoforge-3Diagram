...
import com.gr00ze.libs.ConversionUtils;
...
public class DiagramDataResolver {
    ...
    public static DiagramRecords.InWorldForce convertSubLevelToLevel(UUID subLevelId, Vector3dc localOrigin, Vector3dc localDelta)
    {
        ...
        var globalVector = ConversionUtils.convertSubLevelToLevel(subLevel, localOrigin, localDelta);
    ...
    public static @Nullable Vec3 getInWorldMassPosition(UUID completed) {
        Minecraft mc = Minecraft.getInstance();
